...
namespace Service
{
    ...
    public class StudentService : IStudentService
    {
        ...
        public IEnumerable<Student> GetAll()
        {
            ...
            try
            {
                result = _studentDbContext.Students.ToList();
            }
        ...
        public Student Get(int id)
        {
            ...
            try
            {
                result = _studentDbContext.Students.Single(x => x.StudentId == id);
            }
            catch (System.Exception)
            {
        ...
        public bool Update(Student model)
        {
            try
            {
                var originalModel = _studentDbContext.Students.Single(x =>
